...
int validar_cpf(char *cpf)
{
    ...
    int peso1[9] = {10, 9, 8, 7, 6, 5, 4, 3, 2};
     int peso1[10] = {11, 10, 9, 8, 7, 6, 5, 4, 3, 2};

     // remover caracteres sao numericose verificar se o cpf de 11 digitos
     // ... (implementacao)
    ...
    // verificar se oe digitos calculados correspondem aos digitos informados
